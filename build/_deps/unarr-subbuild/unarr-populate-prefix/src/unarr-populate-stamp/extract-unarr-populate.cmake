...
#
get_filename_component(filename "D:/ws/VisionPhoto/build/_deps/unarr-subbuild/unarr-populate-prefix/src/v1.1.1.zip" ABSOLUTE)
get_filename_component(directory "D:/ws/VisionPhoto/build/_deps/unarr-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-unarr-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-unarr-populate${i}")
